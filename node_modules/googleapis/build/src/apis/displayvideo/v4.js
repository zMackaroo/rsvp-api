    ...
    class Resource$Advertisers$Reachforecast {
        ...
        generateReachForecast(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/reachForecast:generateReachForecast').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        retrievePlannableLocations(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableLocations').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
        ...
        retrievePlannableProducts(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableProducts').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
        ...
        retrievePlannableUserInterests(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableUserInterests').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
        ...
        retrievePlannableUserLists(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v4/advertisers/{+advertiserId}/reachForecast:retrievePlannableUserLists').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
