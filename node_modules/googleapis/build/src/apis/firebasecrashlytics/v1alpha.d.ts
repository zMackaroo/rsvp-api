...
export declare namespace firebasecrashlytics_v1alpha {
    ...
    export class Resource$Projects$Apps$Events {
         ...
         */
        batchGet(params: Params$Resource$Projects$Apps$Events$Batchget, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchGet(params?: Params$Resource$Projects$Apps$Events$Batchget, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchGetEventsResponse>>;
        batchGet(params: Params$Resource$Projects$Apps$Events$Batchget, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchGet(params: Params$Resource$Projects$Apps$Events$Batchget, options: MethodOptions | BodyResponseCallback<Schema$BatchGetEventsResponse>, callback: BodyResponseCallback<Schema$BatchGetEventsResponse>): void;
        batchGet(params: Params$Resource$Projects$Apps$Events$Batchget, callback: BodyResponseCallback<Schema$BatchGetEventsResponse>): void;
        batchGet(callback: BodyResponseCallback<Schema$BatchGetEventsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Apps$Events$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Apps$Events$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListEventsResponse>>;
        list(params: Params$Resource$Projects$Apps$Events$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Apps$Events$List, options: MethodOptions | BodyResponseCallback<Schema$ListEventsResponse>, callback: BodyResponseCallback<Schema$ListEventsResponse>): void;
        list(params: Params$Resource$Projects$Apps$Events$List, callback: BodyResponseCallback<Schema$ListEventsResponse>): void;
    ...
    export class Resource$Projects$Apps$Issues {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchUpdate(params: Params$Resource$Projects$Apps$Issues$Batchupdate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchUpdate(params?: Params$Resource$Projects$Apps$Issues$Batchupdate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchUpdateIssuesResponse>>;
        batchUpdate(params: Params$Resource$Projects$Apps$Issues$Batchupdate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchUpdate(params: Params$Resource$Projects$Apps$Issues$Batchupdate, options: MethodOptions | BodyResponseCallback<Schema$BatchUpdateIssuesResponse>, callback: BodyResponseCallback<Schema$BatchUpdateIssuesResponse>): void;
        batchUpdate(params: Params$Resource$Projects$Apps$Issues$Batchupdate, callback: BodyResponseCallback<Schema$BatchUpdateIssuesResponse>): void;
        batchUpdate(callback: BodyResponseCallback<Schema$BatchUpdateIssuesResponse>): void;
        /**
         * Retrieve an issue.
         * @example
         * ```js
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Apps$Issues$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Apps$Issues$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Issue>>;
        get(params: Params$Resource$Projects$Apps$Issues$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Apps$Issues$Get, options: MethodOptions | BodyResponseCallback<Schema$Issue>, callback: BodyResponseCallback<Schema$Issue>): void;
        get(params: Params$Resource$Projects$Apps$Issues$Get, callback: BodyResponseCallback<Schema$Issue>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Apps$Issues$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Apps$Issues$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Issue>>;
        patch(params: Params$Resource$Projects$Apps$Issues$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Apps$Issues$Patch, options: MethodOptions | BodyResponseCallback<Schema$Issue>, callback: BodyResponseCallback<Schema$Issue>): void;
        patch(params: Params$Resource$Projects$Apps$Issues$Patch, callback: BodyResponseCallback<Schema$Issue>): void;
    ...
    export class Resource$Projects$Apps$Issues$Notes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Apps$Issues$Notes$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Apps$Issues$Notes$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Note>>;
        create(params: Params$Resource$Projects$Apps$Issues$Notes$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Apps$Issues$Notes$Create, options: MethodOptions | BodyResponseCallback<Schema$Note>, callback: BodyResponseCallback<Schema$Note>): void;
        create(params: Params$Resource$Projects$Apps$Issues$Notes$Create, callback: BodyResponseCallback<Schema$Note>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Apps$Issues$Notes$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Apps$Issues$Notes$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Apps$Issues$Notes$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Apps$Issues$Notes$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Apps$Issues$Notes$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Apps$Issues$Notes$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Apps$Issues$Notes$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListNotesResponse>>;
        list(params: Params$Resource$Projects$Apps$Issues$Notes$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Apps$Issues$Notes$List, options: MethodOptions | BodyResponseCallback<Schema$ListNotesResponse>, callback: BodyResponseCallback<Schema$ListNotesResponse>): void;
        list(params: Params$Resource$Projects$Apps$Issues$Notes$List, callback: BodyResponseCallback<Schema$ListNotesResponse>): void;
    ...
    export class Resource$Projects$Apps$Reports {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Apps$Reports$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Apps$Reports$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Report>>;
        get(params: Params$Resource$Projects$Apps$Reports$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Apps$Reports$Get, options: MethodOptions | BodyResponseCallback<Schema$Report>, callback: BodyResponseCallback<Schema$Report>): void;
        get(params: Params$Resource$Projects$Apps$Reports$Get, callback: BodyResponseCallback<Schema$Report>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Apps$Reports$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Apps$Reports$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListReportsResponse>>;
        list(params: Params$Resource$Projects$Apps$Reports$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Apps$Reports$List, options: MethodOptions | BodyResponseCallback<Schema$ListReportsResponse>, callback: BodyResponseCallback<Schema$ListReportsResponse>): void;
        list(params: Params$Resource$Projects$Apps$Reports$List, callback: BodyResponseCallback<Schema$ListReportsResponse>): void;
    ...
    export class Resource$Projects$Apps$Users {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deleteCrashReports(params: Params$Resource$Projects$Apps$Users$Deletecrashreports, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        deleteCrashReports(params?: Params$Resource$Projects$Apps$Users$Deletecrashreports, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeleteUserCrashReportsResponse>>;
        deleteCrashReports(params: Params$Resource$Projects$Apps$Users$Deletecrashreports, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        deleteCrashReports(params: Params$Resource$Projects$Apps$Users$Deletecrashreports, options: MethodOptions | BodyResponseCallback<Schema$DeleteUserCrashReportsResponse>, callback: BodyResponseCallback<Schema$DeleteUserCrashReportsResponse>): void;
        deleteCrashReports(params: Params$Resource$Projects$Apps$Users$Deletecrashreports, callback: BodyResponseCallback<Schema$DeleteUserCrashReportsResponse>): void;
        deleteCrashReports(callback: BodyResponseCallback<Schema$DeleteUserCrashReportsResponse>): void;
    }
