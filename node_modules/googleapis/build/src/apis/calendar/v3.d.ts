...
export declare namespace calendar_v3 {
    ...
    export class Resource$Calendars {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        transferOwnership(params: Params$Resource$Calendars$Transferownership, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        transferOwnership(params?: Params$Resource$Calendars$Transferownership, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<void>>;
        transferOwnership(params: Params$Resource$Calendars$Transferownership, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        transferOwnership(params: Params$Resource$Calendars$Transferownership, options: MethodOptions | BodyResponseCallback<void>, callback: BodyResponseCallback<void>): void;
        transferOwnership(params: Params$Resource$Calendars$Transferownership, callback: BodyResponseCallback<void>): void;
