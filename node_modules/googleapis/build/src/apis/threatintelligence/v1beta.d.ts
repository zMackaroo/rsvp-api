...
export declare namespace threatintelligence_v1beta {
    ...
    export class Resource$Projects$Alerts {
        ...
        getPassword(params?: Params$Resource$Projects$Alerts$Getpassword, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Alert>>;
        ...
        getPassword(params: Params$Resource$Projects$Alerts$Getpassword, options: MethodOptions | BodyResponseCallback<Schema$Alert>, callback: BodyResponseCallback<Schema$Alert>): void;
        getPassword(params: Params$Resource$Projects$Alerts$Getpassword, callback: BodyResponseCallback<Schema$Alert>): void;
