...
export declare namespace policytroubleshooter_v3beta {
    ...
    export class Resource$Iam {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        troubleshootError(params: Params$Resource$Iam$Troubleshooterror, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        troubleshootError(params?: Params$Resource$Iam$Troubleshooterror, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyErrorResponse>>;
        troubleshootError(params: Params$Resource$Iam$Troubleshooterror, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        troubleshootError(params: Params$Resource$Iam$Troubleshooterror, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyErrorResponse>, callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyErrorResponse>): void;
        troubleshootError(params: Params$Resource$Iam$Troubleshooterror, callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyErrorResponse>): void;
        troubleshootError(callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3betaTroubleshootIamPolicyErrorResponse>): void;
    }
