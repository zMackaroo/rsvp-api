...
export declare namespace netapp_v1beta1 {
    ...
    export class Resource$Projects$Locations$Volumes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getSplitStatus(params: Params$Resource$Projects$Locations$Volumes$Getsplitstatus, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getSplitStatus(params?: Params$Resource$Projects$Locations$Volumes$Getsplitstatus, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SplitStatus>>;
        getSplitStatus(params: Params$Resource$Projects$Locations$Volumes$Getsplitstatus, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getSplitStatus(params: Params$Resource$Projects$Locations$Volumes$Getsplitstatus, options: MethodOptions | BodyResponseCallback<Schema$SplitStatus>, callback: BodyResponseCallback<Schema$SplitStatus>): void;
        getSplitStatus(params: Params$Resource$Projects$Locations$Volumes$Getsplitstatus, callback: BodyResponseCallback<Schema$SplitStatus>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        startSplit(params: Params$Resource$Projects$Locations$Volumes$Startsplit, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        startSplit(params?: Params$Resource$Projects$Locations$Volumes$Startsplit, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        startSplit(params: Params$Resource$Projects$Locations$Volumes$Startsplit, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        startSplit(params: Params$Resource$Projects$Locations$Volumes$Startsplit, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        startSplit(params: Params$Resource$Projects$Locations$Volumes$Startsplit, callback: BodyResponseCallback<Schema$Operation>): void;
